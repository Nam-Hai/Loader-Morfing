...
void main() {
  ...
  vec2 smallDisplacment = vec2(cos(time*2.), sin(time* 2.)) *progE * (dists.r + dists.g -4. * dists.b) * 0.005;

  vec2 smallDisplacmentNormal = vec2(cos(time*2.), sin(time* 2.)) *mix(0.1, 1., progE) * (-2. *distxs.r ) * 0.001;
